...
public class Ejemplo05_CajeraThread extends Thread
{
	private String nombre;
	private Ejemplo05_Cliente cliente;
	private long initialTime;
	// Constructor, getter & setter
	public Ejemplo05_CajeraThread(String n, Ejemplo05_Cliente c, long i)
	{
		nombre = n;
		cliente = c;
		initialTime = i;
	...
	public void run()
	{
		...
		for (int i = 0; i < this.cliente.getCarroCompra().length; i++)
		{
			...
			System.out.println("Procesado el producto " + (i + 1) + " del cliente" + this.cliente.getNombre() + "->Tiempo: " + (System.currentTimeMillis() -
